...
permission_query_conditions = {
	...
	"Builder Extension Method Grant": "builder.extensions.access.method_grant_conditions",
...
has_permission = {
	...
	"Builder Extension Method Grant": "builder.extensions.access.owns_through_installation",
