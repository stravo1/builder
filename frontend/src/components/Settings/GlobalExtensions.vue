<template>
	<div class="flex flex-col gap-5">
		<Switch
			...
			@update:modelValue="
				(val: Boolean) => {
					builderStore.updateBuilderSettings('disable_extensions', val);
				}
			" />

		<hr class="w-full boder-outline-gray-2" />
		...
		<BuilderInput
			...
			@update:modelValue="(val: string) => builderStore.updateBuilderSettings('hub_url', val)" />
	</div>
</template>
